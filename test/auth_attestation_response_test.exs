defmodule AuthAttestationResponseTest do
  ...
  test "is valid if everything's in place" do
    ...
    authenticator = FakeAuthenticator.create(
      %{challenge: original_challenge, context: %{origin: origin}}
    )
    ...
    {:ok, auth_attestation_response} = AuthAttestationResponse.new(authenticator.attestation_object)
  ...
  test "can validate fido-u2f attestation" do
    ...
    {:ok, original_challenge} = "11CzaFXezx7YszNaYE3pag=="
    |> Base.decode64()
  ...
  test "origin validation matches the default one" do
    ...
    authenticator = %{challenge: original_challenge, context: %{origin: original_origin}}
  ...
  test "rp_id validation matches the default one" do
    ...
    original_origin = FakeAuthenticator.fake_origin
    rp_id = "localhost"
    authenticator = %{challenge: original_challenge, rp_id: rp_id, context: %{origin: original_origin}}
    |> FakeAuthenticator.create()
